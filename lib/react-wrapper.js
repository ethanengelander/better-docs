...
const _react = _interopRequireDefault(require("react")),
    ...
    //_brace = _interopRequireDefault(require("brace")),

    _reactAce = _interopRequireDefault(require("react-ace")),

    _reactFrameComponent = _interopRequireWildcard(require("react-frame-component"));

require("brace/mode/jsx");

require("brace/theme/monokai");
const Babel = require("@babel/cli/lib/babel/util");
        ...
        _createClass(Wrapper, [{
            ...
            value: function computeHeight() {
                const height = this.state.height,
                 padding = 5; // buffer for any unstyled margins
